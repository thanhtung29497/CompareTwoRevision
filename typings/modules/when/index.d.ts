...
declare module 'when/index' {
import main = require('~when/index');
export = main;
}

// Generated by typings
// Source: https://raw.githubusercontent.com/types/npm-when/5e05a8f9b38372953ceafa57603be8fe1623e32f/2/node.d.ts
declare module '~when/node' {
import when = require('~when/index');
import _ = when._;
