...
export declare class StructureVersionInfo extends VersionInfo {
    ...
    checkStructureVersion(instance: structures.IStructure, includeWarnings: boolean): void;
...
export declare class PropertyVersionInfo extends VersionInfo {
    ...
    checkPropertyVersion(property: AbstractProperty<any, any>, includeWarnings: boolean): void;
}
export declare function createInVersionCheck(model: IAbstractModel, typeName: string, allowedVersions: string[]): void;
export declare function isNotBefore(versionString: string, model: IAbstractModel): boolean;
